...
export default function PrivacyPolicy() {
  return (
    <Layout>
      <div className="prose lg:prose-xl text-white [&_*]:text-white">
        <h1>Privacy Policy</h1>
        <p>Updated at 2024-06-27</p>

        <p>
          Monika Notifier (&quot;we,&quot; &quot;our,&quot; or &quot;us&quot;)
        ...
        <p>
          ...
          application, Monika Notifier. By accessing or using our Service, you
        ...
        <ul>
          ...
          <li>
            ...
            &quot;Company,&quot; &quot;we,&quot; &quot;us,&quot; or
            &quot;our,&quot; it refers to PT Artha Rajamas Mandiri, Jl. BSD
            Grand Boulevard, BSD Green Office Park, BSD City, Kel. Sampora, Kec.
            Cisauk, Kab. Tangerang – Banten 15345 that is responsible for your
            information under this Privacy Policy.
          </li>
          <li>
            <strong>Country:</strong> where Monika Notifier or the
            owners/founders of Monika Notifier are based, in this case is
            Indonesia
          </li>
          <li>
            <strong>Customer:</strong> refers to the company, organization or
            person that signs up to use the Monika Notifier Service to manage
          ...
          <li>
            ...
            visit Monika WhatsApp Notifier and use the services.
          </li>
          <li>
          ...
          <li>
            ...
            employed by Monika WhatsApp Notifier or are under contract to
          ...
          <li>
            <strong>Service:</strong> refers to the service provided by Monika
            Notifier as described in the relative terms (if available) and on
            this platform.
          </li>
          <li>
          ...
          <li>
            <strong>Website:</strong> Monika Notifier&apos;s site, which can be
            accessed via this URL:{' '}
            <a href="https://whatsapp.hyperjump.tech">
              https://whatsapp.hyperjump.tech
            </a>
          </li>
          <li>
            <strong>You:</strong> a person or entity that is registered with
            Monika WhatsApp Notifier to use the Services.
          </li>
        </ul>
        ...
        <p>
          ...
          interest in becoming a Monika Notifier customer, we receive
          information from a third party that provides automated fraud detection
          services to Monika Notifier. We also occasionally collect information
        ...
        <p>
          Monika Notifier will collect personal information that you submit to
        ...
        <p>
          ...
          absolute security of any information you transmit to Monika Notifier
        ...
        <p>
          Monika Notifier is incorporated in Indonesia. Information collected
        ...
        <h2>
          Is the information collected through the Monika Notifier Service
          secure?
        </h2>
        <p>
        ...
        <p>
          ...
          information Monika Notifier collects depend on your relationship with
          Monika Notifier. Personnel may update or correct their information as
        ...
        <h2>Personnel</h2>
        <p>
          If you are a Monika Notifier worker or applicant, we collect
        ...
        <p>
          ...
          of the assets of Monika Notifier or any of its Corporate Affiliates
          (as defined herein), or that portion of Monika WhatsApp Notifier or
          any of its Corporate Affiliates to which the Service relates, or in
        ...
        <p>
          ...
          control with Monika Notifier, whether by ownership or otherwise. Any
        ...
        <h2>Cookies</h2>
        <p>
          Monika Notifier uses &quot;Cookies&quot; to identify the areas of our
        ...
        <p>
          You acknowledge and agree that Monika Notifier shall not be
          ...
          decency, quality or any other aspect thereof. Monika Notifier does not
          ...
          Services and links thereto are provided solely as a convenience to you
        ...
        <p>
          ...
          the right thing to do. At Monika Notifier we strongly believe that
        ...
        <ul>
          <li>Via Email: facebook(at)hyperjump(dot)tech</li>
        </ul>
      </div>
    </Layout>
  );
