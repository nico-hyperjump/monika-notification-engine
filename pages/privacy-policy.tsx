...
export default function PrivacyPolicy() {
  return (
    <Layout>
      <h1 className="text-2xl lg:text-3xl my-8">Privacy Policy</h1>
      <p className="mb-4">Updated at 2022-11-15</p>

      <p className="mb-4">
        Monika Notifier (“we,” “our,” or “us”) is committed to protecting your
        privacy. This Privacy Policy explains how your personal information is
        collected, used, and disclosed by Monika WhatsApp Notifier.
      </p>
      <p className="mb-4">
        ...
        Monika Notifier. By accessing or using our Service, you signify that you
      ...
      <h1 className="text-2xl lg:text-3xl my-8">Definitions and key terms</h1>
      <div className="mb-4">
        ...
        <ul className="list-disc mb-2">
          ...
          <li className="mb-1">
            ...
            it refers to PT Artha Rajamas Mandiri, CoHive D.Lab 5th Floor, Jl.
            Riau No.1, RT.9/RW.5, Gondangdia, Kec. Menteng, Kota Jakarta Pusat,
            Daerah Khusus Ibukota Jakarta 10350 that is responsible for your
            information under this Privacy Policy.
          </li>
          <li className="mb-1">
            Country: where Monika Notifier or the owners/founders of Monika
            Notifier are based, in this case is Indonesia
          </li>
          <li className="mb-1">
            Customer: refers to the company, organization or person that signs
            up to use the Monika Notifier Service to manage the relationships
            with your consumers or service users.
          </li>
          <li className="mb-1">
            Device: any internet connected device such as a phone, tablet,
            computer or any other device that can be used to visit Monika
            WhatsApp Notifier and use the services.
          </li>
          <li className="mb-1">
          ...
          <li className="mb-1">
            Personnel: refers to those individuals who are employed by Monika
            WhatsApp Notifier or are under contract to perform a service on
          ...
          <li className="mb-1">
            Service: refers to the service provided by Monika Notifier as
          ...
          <li className="mb-1">
            Website: Monika Notifier's site, which can be accessed via this URL:{' '}
          </li>
          <li className="mb-1">
            You: a person or entity that is registered with Monika WhatsApp
            Notifier to use the Services.
          </li>
        </ul>
      </div>
      <h1 className="text-2xl lg:text-3xl my-8">
      ...
      <ul className="list-disc">
        <li className="mb-1">Name / Username</li>
      ...
      <div className="mb-4">
        ...
        <ul className="list-disc">
          ...
          <li className="mb-1">To process transactions</li>
          <li className="mb-1">
            To administer a contest, promotion, survey or other site feature
          </li>
          <li className="mb-1">To send periodic emails</li>
        </ul>
      </div>
      <h1 className="text-2xl lg:text-3xl my-8">
        When does Monika Notifier use end user information from third parties?
      </h1>
      <p className="mb-4">
        Monika Notifier will collect End User Data necessary to provide the
        Monika Notifier services to our customers.
      </p>
      <p className="mb-4">
      ...
      <h1 className="text-2xl lg:text-3xl my-8">
        When does Monika Notifier use customer information from third parties?
      </h1>
      <p className="mb-4">
        ...
        in becoming a Monika Notifier customer, we receive information from a
        third party that provides automated fraud detection services to Monika
        Notifier. We also occasionally collect information that is made publicly
      ...
      <p className="mb-4">
        Monika Notifier will collect personal information that you submit to us.
      ...
      <p className="mb-4">
        We keep your information only so long as we need it to provide Monika
        WhatsApp Notifier to you and fulfill the purposes described in this
      ...
      <p className="mb-4">
        ...
        any information you transmit to Monika Notifier or guarantee that your
      ...
      <p className="mb-4">
        Monika Notifier is incorporated in Indonesia. Information collected via
      ...
      <h1 className="text-2xl lg:text-3xl my-8">
        Is the information collected through the Monika Notifier Service secure?
      </h1>
      <p className="mb-4">
      ...
      <p className="mb-4">
        ...
        Monika Notifier collects depend on your relationship with Monika
        Notifier. Personnel may update or correct their information as detailed
      ...
      <h1 className="text-2xl lg:text-3xl my-8">Personnel</h1>
      <p className="mb-4">
        If you are a Monika Notifier worker or applicant, we collect information
      ...
      <h1 className="text-2xl lg:text-3xl my-8">Sale of Business</h1>
      <p className="mb-4">
        ...
        the assets of Monika Notifier or any of its Corporate Affiliates (as
        defined herein), or that portion of Monika WhatsApp Notifier or any of
      ...
      <h1 className="text-2xl lg:text-3xl my-8">Affiliates</h1>
      <p className="mb-4">
        ...
        Monika Notifier, whether by ownership or otherwise. Any information
      ...
      <h1 className="text-2xl lg:text-3xl my-8">Governing Law</h1>
      <p className="mb-4">
      ...
      <p className="mb-4">
        By using Monika Notifier or contacting us directly, you signify your
      ...
      <h1 className="text-2xl lg:text-3xl my-8">Your Consent</h1>
      <p className="mb-4">
      ...
      <h1 className="text-2xl lg:text-3xl my-8">Links to Other Websites</h1>
      <p className="mb-4">
        This Privacy Policy applies only to the Services. The Services may
        contain links to other websites not operated or controlled by Monika
        WhatsApp Notifier. We are not responsible for the content, accuracy or
      ...
      <h1 className="text-2xl lg:text-3xl my-8">Cookies</h1>
      <p className="mb-4">
        Monika Notifier uses "Cookies" to identify the areas of our website that
      ...
      <h1 className="text-2xl lg:text-3xl my-8">Kids' Privacy</h1>
      <p className="mb-4">
      ...
      <h1 className="text-2xl lg:text-3xl my-8">Third-Party Services</h1>
      <p className="mb-4">
      ...
      <p className="mb-4">
        You acknowledge and agree that Monika Notifier shall not be responsible
        ...
        or any other aspect thereof. Monika Notifier does not assume and shall
      ...
      <h1 className="text-2xl lg:text-3xl my-8">What is GDPR?</h1>
      <p className="mb-4">
      ...
      <h1 className="text-2xl lg:text-3xl my-8">What is personal data?</h1>
      <p className="mb-4">
      ...
      <h1 className="text-2xl lg:text-3xl my-8">Why is GDPR important?</h1>
      <p className="mb-4">
        ...
        At Monika Notifier we strongly believe that your data privacy is very
      ...
      <p className="mb-4">
        ...
        requirements of GDPR. Monika Notifier processes or stores all personal
      ...
      <h1 className="text-2xl lg:text-3xl my-8">California Residents</h1>
      <p className="mb-4">
      ...
      <h1 className="text-2xl lg:text-3xl my-8">Contact Us</h1>
      <p className="mb-4">
      ...
      <ul className="list-disc">
        <li className="mb-1">
          Via Email:{' '}
          <a href="mailto:facebook@hyperjump.tech" className="hover:underline">
            facebook(at)hyperjump(dot)tech
          </a>
        </li>
      </ul>
    </Layout>
